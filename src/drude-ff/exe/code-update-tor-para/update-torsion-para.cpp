...
int main(void)
{
	...
	Mol.ReadPSF("drude-mol.xpsf", 0, 1);	//the first parameter is the xpsf file name; the second parameter is 0 (only one molecule in xpsf) or 1 (two molecules in xpsf). 
