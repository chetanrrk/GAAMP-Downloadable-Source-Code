...
public:
	...
	void ReadPSF(char szNamePsf[], int MultiSegment, int To_Delete_Last_Atom);
	...
	double Cal_Dipole(double& dipole_x, double& dipole_y, double& dipole_z);
