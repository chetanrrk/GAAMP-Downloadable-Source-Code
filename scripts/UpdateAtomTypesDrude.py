...
class Mol:
    ...
    def reNameAtomTypes(self):
	    ...
	    if a=="DRUD" or a=="LP": 
		self.newAtomTypes[a.upper()]=a.upper()
		continue	
	    elif "_" in a:
		at = a.split("_")	
	...
	fout = open("drude-mol_final.rtf","w")
	...
	fout = open("drude-mol_final.prm","w")
...
if __name__=="__main__":	
   ...
   os.chdir(baseDir+"/drude_results")
   
   prm = "";rtf ="" 
   if os.path.isfile("drude-mol-tor.prm"):
	prm = "drude-mol-tor.prm"
   elif os.path.isfile("drude-mol.prm"):
	prm = "drude-mol.prm"
   print "UPDATING_PRM:",prm
	
   if os.path.isfile("drude-mol-tor.rtf"):
	rtf = "drude-mol-tor.rtf"
   elif os.path.isfile("drude-esp-wat-mol.rtf"):
	rtf = "drude-esp-wat-mol.rtf"	
   elif os.path.isfile("drude-esp-mol.rtf"):
	rtf = "drude-esp-mol.rtf"
   elif os.path.isfile("drude-mol.rtf"):		 	
	rtf = "drude-mol.rtf"
